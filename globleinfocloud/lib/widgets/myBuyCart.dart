...
import 'package:globleinfocloud/screens/Home/ProductModel.dart';
import 'package:globleinfocloud/screens/Home/order_rent.dart';
        ...
        floatingActionButton: GestureDetector(onTap: (){
         if(amount>0){
            Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => CheckoutScreenBuy (
                          amount: amount,
                          bookname : Buyproduct, 
                        ),
                      ),
